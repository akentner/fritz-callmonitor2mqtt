...
func TestEndToEndIntegration(t *testing.T) {
	...
	mqttClient := mqtt.NewClient("localhost", 1883, "", "", "test-client", "fritz", 0, false, 30*time.Second, 5*time.Second, "debug", dbClient, nil, []string{}, 30, "Test Device", "test-device", "test-version")
